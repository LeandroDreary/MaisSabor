...
const Card = ({ product, children }: { product: ProductType, children?: any }) => {
  return (
    <div
      ...
      className="col-span-4 w-full transform hover-z-70 mx-auto duration-300 ease-out bg-white hover:scale-110 shadow-lg sm:col-span-2 lg:col-span-1 border border-barbina-light-brown mt-5">
